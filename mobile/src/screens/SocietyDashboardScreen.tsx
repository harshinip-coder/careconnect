  ...
  const fetchIncidents = async () => {
    try {
      ...
      const alertPending = list.find(i =>
        ...
        (i.current_stage === 'COMMUNITY' || i.current_stage === 'SOCIETY_MEMBER' || i.current_stage === 'COMPLETED' || i.status === 'UNRESPONDED')
      );
        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center', padding: 20 }}>
          <View style={{ width: '100%', backgroundColor: '#FFFFFF', borderRadius: 16, padding: 20 }}>
            ...
            <TextInput
              ...
              placeholder="e.g. Emergency handled successfully. Resident is safe."
